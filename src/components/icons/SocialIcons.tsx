  ...
  const iconData = [
    {
      ...
      url: "https://www.facebook.com/gabriel.medina.1291421",
      aos: "fade-up",
      aosDelay: 100,
    },
    {
      name: "Instagram",
      Icon: FaInstagram,
      lightModeColor: "rgba(236, 72, 153, 0.7)",
      darkModeColor: "rgba(236, 72, 153, 0.7)",
      lightModeHoverColor: "rgb(236, 72, 153)",
      darkModeHoverColor: "rgb(236, 72, 153)",
      url: "https://www.instagram.com/gabo_medina11?igsh=MXAycmZjbDNzdDl5Nw==",
      aos: "fade-up",
      aosDelay: 200,
    },
    {
      name: "X",
      Icon: FaXTwitter,
      lightModeColor: "rgba(0, 0, 0, 0.7)",
      darkModeColor: "rgba(0, 0, 0, 0.7)",
      lightModeHoverColor: "rgb(0, 0, 0)",
      darkModeHoverColor: "rgb(0, 0, 0)",
      url: "https://x.com/gabiGolDev",
      aos: "fade-up",
      aosDelay: 300,
    },
    {
      ...
      url: "https://github.com/GabooMedina",
      aos: "fade-up",
      aosDelay: 400,
    },
    {
      name: "LinkedIn",
      Icon: FaLinkedin,
      lightModeColor: "rgba(10, 102, 194, 0.7)",
      darkModeColor: "rgba(10, 102, 194, 0.7)",
      lightModeHoverColor: "rgb(10, 102, 194)",
      darkModeHoverColor: "rgb(10, 102, 194)",
      url: "https://www.linkedin.com/in/gabriel-medina-689522363/",
      aosDelay: 500,
    },
  ];
