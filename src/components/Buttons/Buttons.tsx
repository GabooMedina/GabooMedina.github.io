...
const Buttons = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = fileUrl;
    link.download = 'CV_Gabriel_Medina.pdf'; // Nombre con el que se descargará el archivo
  ...
  return (
    <div data-aos="fade-right" data-aos-delay="400" className="flex gap-4">
      ...
      <div className="relative group" data-aos="zoom-in-up">
        ...
        <div
          className={`absolute -inset-0.5 rounded-lg ${isDarkMode
      ...
      border ${isDarkMode ? "border-emerald-400/30" : "border-emerald-500/30"
            } hover:border-transparent
      shadow-lg ${isDarkMode ? "shadow-emerald-400/20" : "shadow-emerald-500/20"
      ...
      shadow-lg ${isDarkMode ? "shadow-emerald-400/10" : "shadow-emerald-500/10"
