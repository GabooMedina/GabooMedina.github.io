      ...
      <article className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 w-full max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            >
              <div
                className={`${theme === "dark" ? "bg-[#1c1c22]" : "bg-white"
                  } rounded-full p-1 overflow-hidden w-full h-full`}
              >
                <img
                  src={Profile}
                  alt="Neath's profile"
                  className="rounded-full w-full h-full object-cover object-[center_30%] transform transition-transform duration-700 hover:scale-105"
                  loading="eager"
                  decoding="async"
                />
              </div>
