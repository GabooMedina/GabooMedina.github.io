...
import backgroundImage from '../../../assets/contact.png'; // Ajusta la ruta
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden rounded-xl">
              <img
                src={backgroundImage}
                alt="Background"
                className="w-full h-full object-cover opacity-20 hover:opacity-30 transition-opacity duration-300"
              />
            ...
            <form onSubmit={handleSubmit} className="relative z-10">
              ...
              <div className="mb-6">
                <label
                  htmlFor="name"
                  className={`block text-sm font-medium mb-2 transition-all duration-300 ${activeField === "name" ? "text-[#00ff99]" : "text-gray-300"
                    }`}
                >
                  Your Name
                </label>
                <div className="relative">
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 ${activeField === "name"
                        ? "border-[#00ff99] ring-[#00ff99]/50 text-white"
                        : "border-gray-600 text-gray-300"
                      }`}
                  />
                  <div
                    className={`absolute bottom-0 left-0 h-0.5 bg-[#00ff99] transition-all duration-300 ${activeField === "name" ? "w-full" : "w-0"
                      }`}
                  ></div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <label
                  htmlFor="email"
                  className={`block text-sm font-medium mb-2 transition-all duration-300 ${activeField === "email" ? "text-[#00ff99]" : "text-gray-300"
                    }`}
                >
                  Your Email
                </label>
                <div className="relative">
                  <input
                    ...
                    onBlur={() => setActiveField(null)}
                    required
                    className={`w-full px-4 py-3 bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 ${activeField === "email"
                        ? "border-[#00ff99] ring-[#00ff99]/50 text-white"
                        : "border-gray-600 text-gray-300"
                      }`}
                  />
                  <div
                    className={`absolute bottom-0 left-0 h-0.5 bg-[#00ff99] transition-all duration-300 ${activeField === "email" ? "w-full" : "w-0"
                      }`}
                  ></div>
                </div>
              </div>
              ...
              <div className="mb-8">
                <label
                  htmlFor="message"
                  className={`block text-sm font-medium mb-2 transition-all duration-300 ${activeField === "message"
                      ? "text-[#00ff99]"
                      : "text-gray-300"
                    }`}
                >
                ...
                <div className="relative">
                  <textarea
                    ...
                    onBlur={() => setActiveField(null)}
                    required
                    className={`w-full px-4 py-3 bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 ${activeField === "message"
                        ? "border-[#00ff99] ring-[#00ff99]/50 text-white"
                        : "border-gray-600 text-gray-300"
                      }`}
                  ></textarea>
                  <div
                    className={`absolute bottom-0 left-0 h-0.5 bg-[#00ff99] transition-all duration-300 ${activeField === "message" ? "w-full" : "w-0"
                      }`}
                  ></div>
                </div>
              </div>
