import { FaReact, FaServer, FaAndroid  } from 'react-icons/fa';
...
export default function Experience() {
  ...
  const experienceItems = [
   {
    ...
    institution: "DigitalFront EC (Quito)",
    description: "Developed responsive user interfaces for banking applications using React.js and TypeScript. Implemented state management with Redux Toolkit and improved page load speed by 30% through code optimization.",
    skills: ["React", "TypeScript", "Redux Toolkit", "Tailwind CSS", "Jest Testing"],
  ...
  },
  {
    ...
    institution: "AndesTech Solutions (Cuenca)",
    description: "Built RESTful APIs for e-commerce platforms using Node.js and Express. Designed database schemas in MongoDB and implemented authentication with JWT, serving 5,000+ daily requests.",
    skills: ["Node.js", "Express", "MongoDB", "JWT", "REST APIs", "Postman"],
  ...
  institution: "AppSolutions EC (Freelance)",
  description: "Developed native Android applications for Ecuadorian small businesses using Kotlin. Implemented location services and offline storage solutions, improving user engagement by 30% for logistics applications.",
  skills: [
    "Kotlin",
    "Android SDK",
    "Jetpack Compose",
